use crate::view::{graphics::Rect, View, ViewId};
use slotmap::SlotMap;
...
mod test {
    use super::*;
    use crate::view::editor::GutterConfig;
    use crate::view::AppId;
    ...
    fn find_split_in_direction() {
        ...
        let l0 = tree.focus;
        let view = View::new(AppId::default(), GutterConfig::default());
    ...
    fn swap_split_in_direction() {
        ...
        fn doc_id(tree: &Tree, view_id: ViewId) -> Option<AppId> {
