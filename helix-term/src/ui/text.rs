...
impl Text {
    pub fn new(contents: String) -> Self {
        Self {
            contents: ratatui::text::Text::from(contents),
            size: (0, 0),
            viewport: (0, 0),
        }
    }
...
impl From<ratatui::text::Text<'static>> for Text {
    fn from(contents: ratatui::text::Text<'static>) -> Self {
        Self {
            contents,
            size: (0, 0),
            viewport: (0, 0),
...
pub fn required_size(text: &ratatui::text::Text, max_text_width: u16) -> (u16, u16) {
